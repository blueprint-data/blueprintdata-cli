import { LLMClient, GenerateOptions, GenerateResult } from '../../llm/client.js';
import { LLMProvider } from '@blueprintdata/models';

/**
 * Mock LLM client for testing - extends LLMClient to be compatible
 */
export class MockLLMClient extends LLMClient {
   ...
   */
  getCallHistory(): Array<{ prompt: string; options?: GenerateOptions }> {
   ...
   */
  getLastCall(): { prompt: string; options?: GenerateOptions } | undefined {
